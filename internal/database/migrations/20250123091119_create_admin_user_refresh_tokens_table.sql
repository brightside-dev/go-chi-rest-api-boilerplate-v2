...
CREATE TABLE user_refresh_tokens (
    ...
    admin_user_id BIGINT UNSIGNED NOT NULL,             -- Foreign key linking to the users table
    ...
    CONSTRAINT fk_user FOREIGN KEY (admin_user_id) REFERENCES admin_users(id) ON DELETE CASCADE
);
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP TABLE admin_user_refresh_tokens;
-- +goose StatementEnd
